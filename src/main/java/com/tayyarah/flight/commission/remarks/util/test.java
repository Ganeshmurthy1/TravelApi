package com.tayyarah.flight.commission.remarks.util;
...
public class test {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		System.out.println("PLB commission--"+plbCommission.toString());
		
		ObjectMapper mapper = new ObjectMapper();
		
		String plbcommissionJson = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(plbCommission);
		//System.out.println("PLB commission--"+plbcommissionJson);
